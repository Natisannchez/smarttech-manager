    ...
    try {
        ...
        return res.status(400).json({ 
            success: false, 
            message: 'DNI y nombre/apellido son campos requeridos' 
        });
        }
        ...
        return res.status(400).json({ 
            success: false, 
            message: 'Ya existe un técnico con ese DNI' 
        });
        }
        ...
        data: { ...nuevoTecnico, _id: result.insertedId }
        });
    } catch (error) {
    ...
    try {
        ...
        return res.status(400).json({ 
            success: false, 
            message: 'El nombre/apellido es requerido' 
        });
        }
    ...
    try {
        ...
        res.json({ 
        success: true, 
        message: `Técnico ${nuevoEstado ? 'activado' : 'desactivado'} exitosamente`,
